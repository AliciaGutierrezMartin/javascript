...
export const removeNumbreAddressProperty = () => {
  person.address.number = undefined;
};
...
export const getLastPrincipalOfDirector = () => {
 return movie.director.notableFilmography[movie.director.notableFilmography.length - 1]
};
...
export const getDescriptionOfGandalf = () => {
  return movie.characters.find(characters => characters.name =="Gandalf").description;
};
...
export const getRealOfAragorn = () => {
  return movie.characters.find(characters => characters.name =="Aragorn").actor;
};
